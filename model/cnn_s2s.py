...
from keras.layers import Conv1D, MaxPooling1D, LSTM, Dense, Dropout, Dot, Input, Attention, UpSampling1D, Conv1DTranspose, BatchNormalization, GlobalMaxPooling1D
